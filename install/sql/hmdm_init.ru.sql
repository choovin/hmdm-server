...
INSERT INTO applications (id, pkg, name, showicon, customerid, system, latestversion, runafterinstall) VALUES 
    ...
    (46, 'com.hmdm.launcher', 'Runnode MDM', false, 1, false, 10045, false),
    (47, 'com.huawei.android.internal.app', 'Huawei - выбор лаунчера', false, 1, true, 10046, false),
    (48, 'com.hmdm.pager', 'Runnode MDM Пейджер', true, 1, false, 10047, false),
    (49, 'com.hmdm.phoneproxy', 'Прокси для телефона', true, 1, false, 10048, false),
    (50, 'com.hmdm.emuilauncherrestarter', 'Помощник обновления Runnode MDM', false, 1, false, 10049, false),
...
(3, 'Фоновый режим', 'Runnode MDM работает в фоне, не ограничивая возможности пользователя.', 0, '12345678', '', '', NULL, 'SMALL', 'NO_HEADER', true, 1, NULL, NULL, NULL, NULL, 10045, 'com.hmdm.launcher.AdminReceiver', false, '350e0fb7fc3f4b7fe61cac75fd43818f', NULL, false, false, 0, NULL, NULL, 'mqttAlarm', 300, true, true, true);
...
INSERT INTO plugin_devicelog_settings_rules (id, settingid, name, active, applicationid, severity) VALUES (1, 1, 'Runnode MDM', true, 46, 'VERBOSE');
