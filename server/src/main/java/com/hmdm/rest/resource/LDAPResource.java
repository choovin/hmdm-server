...
public class LDAPResource {
    ...
    public Response updateLDAPConfiguration(
        ...
        if (config == null) {
            return Response.error(ERROR_CODE_VALIDATION_ERROR, "Configuration is required");
        }
        ...
        if (existing == null) {
            ...
            return Response.error(Response.ERROR_CODE_UNKNOWN_ERROR, "Failed to update configuration");
        }
    }
    ...
    public Response deleteLDAPConfiguration(
        ...
        return Response.error(Response.ERROR_CODE_NOT_FOUND, "Configuration not found");
    }
    ...
    public Response getGroupMappings(
        ...
        if (configId == null) {
            return Response.error(ERROR_CODE_VALIDATION_ERROR, "Config ID is required");
        }
    ...
    public Response createGroupMapping(
        ...
        if (mapping == null || mapping.getLdapGroupDn() == null || mapping.getLdapGroupDn().isEmpty()) {
            return Response.error(ERROR_CODE_VALIDATION_ERROR, "LDAP group DN is required");
        }
        if (mapping.getLocalRole() == null || mapping.getLocalRole().isEmpty()) {
            return Response.error(ERROR_CODE_VALIDATION_ERROR, "Local role is required");
        }
    ...
    public Response updateGroupMapping(
            ...
            @ApiParam("Group mapping") LDAPGroupMapping mapping) {
        if (mapping == null) {
            return Response.error(ERROR_CODE_VALIDATION_ERROR, "Mapping is required");
        }
        mapping.setId(id);
        ...
        return Response.error(Response.ERROR_CODE_NOT_FOUND, "Mapping not found");
    }
    ...
    public Response createSyncLog(
        ...
        if (log == null || log.getSyncType() == null) {
            return Response.error(ERROR_CODE_VALIDATION_ERROR, "Sync type is required");
        }
    ...
    public Response updateSyncLog(
            ...
            @ApiParam("Sync log") LDAPSyncLog log) {
        if (log == null) {
            return Response.error(ERROR_CODE_VALIDATION_ERROR, "Sync log is required");
        }
        log.setId(id);
        ...
        return Response.error(Response.ERROR_CODE_NOT_FOUND, "Sync log not found");
    }
    ...
    public Response testConnection(
        ...
        if (config == null || config.getServerHost() == null || config.getServerHost().isEmpty()) {
            return Response.error(ERROR_CODE_VALIDATION_ERROR, "Server host is required");
        }
        if (config.getBaseDn() == null || config.getBaseDn().isEmpty()) {
            return Response.error(ERROR_CODE_VALIDATION_ERROR, "Base DN is required");
        }

        // This is a simplified test - in production, this would actually try to connect to LDAP
        // For now, just validate the configuration
        if (!config.isValid()) {
            return Response.error(ERROR_CODE_VALIDATION_ERROR, "Invalid configuration");
        }
