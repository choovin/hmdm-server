...
document.localization ['en_US'] = {
    ...
    'button.device.remote.view': 'Remote View Screen',
    'button.device.remote.control': 'Remote Control Device',
    'button.network.rules': 'Network Traffic Rules',
    'button.network.settings': 'Network Settings',
    'button.traffic.logs': 'Traffic Logs',
    'button.login': 'Login',
    ...
    'question.device.reboot': 'Send reboot command to device "${deviceNumber}"?',
    'question.device.lock': 'Send lock command to device "${deviceNumber}"?',
    'question.device.factory.reset': 'Send factory reset command to device "${deviceNumber}"? This will erase all data!',
    ...
    'question.device.remote.view': 'Start remote view session for device "${deviceNumber}"?',
    'question.device.remote.control': 'Start remote control session for device "${deviceNumber}"?',
    ...
    'success.device.remote.view.sent': 'Remote view session has been started',
    'success.device.remote.control.sent': 'Remote control session has been started',
    ...
    'breadcrumb.contacts': 'Device Contacts',
    'heading.contacts': 'Device Contacts',
    'heading.contact.details': 'Contact Details',
    'button.contacts': 'Device Contacts',
    'button.contacts.sync': 'Sync Contacts',
    'button.contact.add': 'Add Contact',
    ...
    'table.heading.contact.email': 'Email',
    'table.heading.contact.company': 'Company',
    'table.heading.contact.title': 'Title',
    'table.heading.contact.managed': 'Managed',
    'table.heading.contact.synced': 'Synced',
    'table.heading.contact.actions': 'Actions',

    'form.contact.displayName': 'Display Name',
    'form.contact.firstName': 'First Name',
    'form.contact.lastName': 'Last Name',
    'form.contact.phone': 'Phone Number',
    'form.contact.email': 'Email',
    'form.contact.company': 'Company',
    'form.contact.jobTitle': 'Job Title',
    'form.contact.department': 'Department',
    'form.contact.notes': 'Notes',
    'form.contact.isManaged': 'Managed Contact',
    'form.contact.phones': 'Phone Numbers',
    'form.contact.emails': 'Email Addresses',
    'form.contact.phone.type': 'Type',
    'form.contact.phone.number': 'Number',
    'form.contact.phone.primary': 'Primary',
    'form.contact.email.type': 'Type',
    'form.contact.email.address': 'Email',
    'form.contact.email.primary': 'Primary',

    'error.contact.not.found': 'Contact not found',
    'error.contact.empty.name': 'Enter contact name',
    'error.contact.empty.phone': 'Enter phone number',

    'question.contact.delete': 'Delete contact "${contactName}"?',
    'question.contacts.sync': 'Sync contacts to device "${deviceNumber}"?',
    'question.contacts.sync.bulk': 'Sync contacts to selected devices?',

    'success.contact.created': 'Contact created successfully',
    'success.contact.updated': 'Contact updated successfully',
    'success.contact.deleted': 'Contact deleted successfully',
    'success.contacts.synced': 'Contacts sync command sent',

    'notfound.contacts': 'No contacts found.',

    'permission.plugin_contacts_access': 'Manage device contacts',

    'breadcrumb.white.label': 'White Label',
    'heading.white.label': 'White Label / Rebranding',
    'heading.white.label.builds': 'Custom APK Builds',
    'heading.white.label.email.templates': 'Email Templates',
    'heading.white.label.rebranding': 'Rebranding Settings',

    'button.white.label': 'White Label',
    'button.white.label.build': 'Build APK',
    'button.white.label.trigger.build': 'Trigger Build',
    'button.white.label.download': 'Download APK',
    'button.white.label.new.build': 'New Build',
    'button.white.label.save.template': 'Save Template',
    'button.white.label.preview': 'Preview',

    'table.heading.white.label.build.name': 'Build Name',
    'table.heading.white.label.app.name': 'App Name',
    'table.heading.white.label.package': 'Package',
    'table.heading.white.label.version': 'Version',
    'table.heading.white.label.status': 'Status',
    'table.heading.white.label.created': 'Created',
    'table.heading.white.label.actions': 'Actions',

    'table.heading.email.template.type': 'Template Type',
    'table.heading.email.template.subject': 'Subject',
    'table.heading.email.template.custom': 'Custom',

    'form.white.label.build.name': 'Build Name',
    'form.white.label.app.name': 'Application Name',
    'form.white.label.package.name': 'Package Name',
    'form.white.label.version.code': 'Version Code',
    'form.white.label.version.name': 'Version Name',
    'form.white.label.server.url': 'Server URL',
    'form.white.label.icon': 'App Icon',
    'form.white.label.splash': 'Splash Screen',
    'form.white.label.custom.colors': 'Custom Colors',
    'form.white.label.custom.strings': 'Custom Strings',

    'form.rebranding.custom.logo': 'Custom Logo',
    'form.rebranding.custom.favicon': 'Custom Favicon',
    'form.rebranding.custom.css': 'Custom CSS',
    'form.rebranding.primary.color': 'Primary Color',
    'form.rebranding.secondary.color': 'Secondary Color',
    'form.rebranding.accent.color': 'Accent Color',
    'form.rebranding.email.header': 'Email Header HTML',
    'form.rebranding.email.footer': 'Email Footer HTML',
    'form.rebranding.email.subject.prefix': 'Email Subject Prefix',
    'form.rebranding.login.page.html': 'Custom Login Page HTML',
    'form.rebranding.hide.powered.by': 'Hide "Powered by"',
    'form.rebranding.custom.copyright': 'Custom Copyright Text',
    'form.rebranding.custom.domain': 'Custom Domain',
    'form.rebranding.enable.custom.domain': 'Enable Custom Domain',

    'form.email.template.type': 'Template Type',
    'form.email.template.subject': 'Subject',
    'form.email.template.body.html': 'HTML Body',
    'form.email.template.body.text': 'Plain Text Body',

    'white.label.status.pending': 'Pending',
    'white.label.status.building': 'Building',
    'white.label.status.completed': 'Completed',
    'white.label.status.failed': 'Failed',

    'error.white.label.build.not.found': 'Build not found',
    'error.white.label.invalid.package': 'Invalid package name',
    'error.white.label.build.failed': 'Build failed',

    'success.white.label.build.created': 'Build configuration created',
    'success.white.label.build.triggered': 'Build triggered successfully',
    'success.white.label.template.saved': 'Email template saved',
    'success.rebranding.saved': 'Rebranding settings saved',

    'notfound.white.label.builds': 'No builds found.',
    'notfound.email.templates': 'No templates found.',

    'permission.plugin_whitelabel_access': 'White Label / Rebranding',
    'permission.plugin_whitelabel_build_apk': 'Build custom APK',
    'permission.plugin_whitelabel_email_templates': 'Manage email templates',
    'permission.plugin_whitelabel_custom_domain': 'Custom domain setup'
};
