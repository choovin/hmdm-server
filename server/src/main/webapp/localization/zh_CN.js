...
document.localization ['zh_CN'] = {
    ...
    'button.device.remote.view': "远程查看屏幕",
    'button.device.remote.control': "远程控制设备",
    'button.network.rules': "网络流量规则",
    'button.network.settings': "网络设置",
    'button.traffic.logs': "流量日志",
    'button.login' : "登录",
    ...
    'question.device.reboot': "向设备\"${deviceNumber}\"发送重启命令？",
    'question.device.lock': "向设备\"${deviceNumber}\"发送锁定命令？",
    'question.device.factory.reset': "向设备\"${deviceNumber}\"发送恢复出厂设置命令？此操作将删除所有数据！",
    ...
    'question.device.remote.view': "启动对设备\"${deviceNumber}\"的远程查看？",
    'question.device.remote.control': "启动对设备\"${deviceNumber}\"的远程控制？",
    ...
    'success.device.remote.view.sent':"远程查看会话已启动",
    'success.device.remote.control.sent':"远程控制会话已启动",
    ...
    'tab.contacts': "设备通讯录",
    'tab.ldap': "LDAP集成",
    'breadcrumb.ldap': 'LDAP集成',
    'heading.ldap': 'LDAP集成',
    'heading.ldap.config': 'LDAP配置',
    'heading.ldap.auth': '认证设置',
    'heading.ldap.mapping': '用户映射',
    'heading.ldap.groups': '组同步',
    'heading.ldap.status': '连接状态',
    'button.ldap': 'LDAP集成',
    'button.test.connection': '测试连接',

    'label.ldap.enabled': '启用LDAP',
    'label.ldap.url': 'LDAP服务器地址',
    'label.ldap.baseDn': '基础DN',
    'label.ldap.bindDn': '绑定DN',
    'label.ldap.bindPassword': '绑定密码',
    'label.ldap.userFilter': '用户过滤器',
    'label.ldap.userBase': '用户基础DN',
    'label.ldap.groupFilter': '组过滤器',
    'label.ldap.groupBase': '组基础DN',
    'label.ldap.useForAuthentication': '用于管理员认证',
    'label.ldap.useForAuth': '用于管理员认证',
    'label.ldap.userIdAttribute': '用户ID属性',
    'label.ldap.userIdAttr': '用户ID属性',
    'label.ldap.emailAttribute': '邮箱属性',
    'label.ldap.emailAttr': '邮箱属性',
    'label.ldap.nameAttribute': '名称属性',
    'label.ldap.nameAttr': '名称属性',
    'label.ldap.autoCreateUsers': '自动创建用户',
    'label.ldap.autoCreate': '自动创建用户',
    'label.ldap.defaultRoleId': '默认角色',
    'label.ldap.defaultRole': '默认角色',
    'label.ldap.syncGroups': '同步组',
    'label.ldap.groupNameAttribute': '组名属性',
    'label.ldap.groupNameAttr': '组名属性',
    'label.ldap.groupMemberAttribute': '组成员属性',
    'label.ldap.groupMemberAttr': '组成员属性',
    'label.ldap.groupMappings': '组映射',
    'label.ldap.usersFound': '已找到用户',
    'label.ldap.groupsFound': '已找到组',

    'button.add.mapping': '添加映射',

    'help.ldap.enabled': '启用后，系统将从LDAP服务器同步用户和组',
    'help.ldap.url': 'LDAP服务器的地址，如 ldaps://ldap.example.com:636',
    'help.ldap.baseDn': '搜索用户和组的基础DN，如 dc=example,dc=com',
    'help.ldap.userFilter': '用于搜索用户的LDAP过滤器，如 (objectClass=person)',
    'help.ldap.userBase': '搜索用户的基础DN，如 ou=users',
    'help.ldap.groupFilter': '用于搜索组的LDAP过滤器，如 (objectClass=groupOfNames)',
    'help.ldap.groupBase': '搜索组的基础DN，如 ou=groups',
    'help.ldap.bindDn': '用于绑定LDAP服务器的DN，如 cn=admin,dc=example,dc=com',
    'help.ldap.bindPassword': '绑定DN对应的密码',
    'help.ldap.useForAuth': '启用后，管理员可使用LDAP账号登录系统',
    'help.ldap.userIdAttr': '用于匹配用户ID的属性，如 uid 或 cn',
    'help.ldap.emailAttr': '用户的邮箱属性，如 mail',
    'help.ldap.nameAttr': '用户的显示名称属性，如 cn 或 displayName',
    'help.ldap.autoCreateUsers': '启用后，首次登录时自动创建本地用户',
    'help.ldap.defaultRole': '自动创建用户时的默认角色',
    'help.ldap.syncGroups': '启用后，同步LDAP组到系统的角色',
    'help.ldap.groupNameAttr': '组名属性，如 cn',
    'help.ldap.groupMemberAttr': '组成员属性，如 member',

    'warning.ldap.url.required': '请输入LDAP服务器地址',
    'warning.ldap.baseDn.required': '请输入基础DN',
    'success.ldap.saved': 'LDAP配置已保存',
    'error.ldap.save': '保存LDAP配置失败',
    'ldap.test.success': 'LDAP连接成功',
    'ldap.test.failed': 'LDAP连接失败',
    'ldap.status.testing': '正在测试连接...',
    'ldap.status.connected': '已连接',
    'ldap.status.error': '连接失败',
    'ldap.status.notTested': '未测试',

    'tab.remote.control': "远程控制",
    'tab.commands': "远程命令",
    'tab.network.filter': "网络过滤",
    'heading.network.filter': '网络流量过滤',
    'heading.filter.rules': '过滤规则',

    'filter.type.blacklist': '黑名单',
    'filter.type.whitelist': '白名单',

    'button.add.filter': '添加过滤规则',
    'label.select.all': '全选',
    'label.more.rules': '更多规则',
    'placeholder.search.devices': '搜索设备...',
    'message.no.filters': '暂无过滤规则',
    'message.no.devices': '暂无可用设备',
    'tab.export.import': "导入导出",
    'heading.export.import': '设备导入导出',
    'tab.import': '导入',
    'tab.export': '导出',
    'heading.import.devices': '导入设备',
    'heading.export.devices': '导出设备',
    'button.new.import': '新建导入',
    'button.new.export': '新建导出',
    'button.view.details': '查看详情',
    'button.delete': '删除',
    'button.download': '下载',
    'message.no.import.jobs': '暂无导入任务',
    'message.no.export.jobs': '暂无导出任务',
    'label.export.job': '导出任务',
    'label.devices': '设备',
    ...
    'breadcrumb.contacts': '设备联系人',
    'heading.contacts': '设备联系人',
    'heading.contact.details': '联系人详情',
    'button.contacts': '设备联系人',
    'button.contacts.sync': '同步联系人',
    'button.contact.add': '添加联系人',
    'button.contact.edit': '编辑联系人',
    'button.contact.delete': '删除联系人',
    'button.contact.sync': '同步到设备',

    // 联系人页面其他翻译
    'button.refresh': '刷新',
    'button.select.all': '全选',
    'button.sync.selected': '同步所选',
    'heading.no.contacts': '暂无联系人',
    'heading.edit.contact': '编辑联系人',
    'heading.add.contact': '添加联系人',
    'heading.select.devices': '选择设备',
    'label.contact.name': '姓名',
    'label.contact.phone': '电话',
    'label.contact.email': '邮箱',
    'label.contact.company': '公司',
    'label.contact.title': '职位',
    'label.contact.devices': '设备',
    'placeholder.contact.name': '请输入联系人姓名',
    'placeholder.contact.phone': '请输入电话号码',
    'placeholder.contact.email': '请输入邮箱地址',
    'placeholder.contact.company': '请输入公司名称',
    'placeholder.contact.title': '请输入职位',
    'search.contact': '搜索联系人...',
    'search.device': '搜索设备...',
    'tooltip.edit': '编辑',
    'tooltip.delete': '删除',
    'tooltip.sync.to.device': '同步到设备',
    'message.no.contacts.description': '暂无联系人，点击"添加联系人"创建一个。',
    'message.no.devices': '暂无可用设备',

    'table.heading.contact.name': '姓名',
    'table.heading.contact.phone': '电话',
    'table.heading.contact.email': '邮箱',
    'table.heading.contact.company': '公司',
    'table.heading.contact.title': '职位',
    'table.heading.contact.managed': '受管',
    'table.heading.contact.synced': '已同步',
    'table.heading.contact.actions': '操作',

    'form.contact.displayName': '显示名称',
    'form.contact.firstName': '名',
    'form.contact.lastName': '姓',
    'form.contact.phone': '电话号码',
    'form.contact.email': '电子邮箱',
    'form.contact.company': '公司',
    'form.contact.jobTitle': '职位',
    'form.contact.department': '部门',
    'form.contact.notes': '备注',
    'form.contact.isManaged': '受管联系人',
    'form.contact.phones': '电话号码',
    'form.contact.emails': '电子邮箱',
    'form.contact.phone.type': '类型',
    'form.contact.phone.number': '号码',
    'form.contact.phone.primary': '主要',
    'form.contact.email.type': '类型',
    'form.contact.email.address': '邮箱',
    'form.contact.email.primary': '主要',

    'error.contact.not.found': '联系人不存在',
    'error.contact.empty.name': '请输入联系人姓名',
    'error.contact.empty.phone': '请输入电话号码',

    'question.contact.delete': '删除联系人"${contactName}"？',
    'question.contacts.sync': '同步联系人到设备"${deviceNumber}"？',
    'question.contacts.sync.bulk': '同步联系人到所选设备？',

    'success.contact.created': '联系人创建成功',
    'success.contact.updated': '联系人更新成功',
    'success.contact.deleted': '联系人删除成功',
    'success.contacts.synced': '联系人同步命令已发送',

    'error.loading.contacts': '加载联系人失败',
    'confirm.delete.contact': '确认删除联系人',
    'confirm.delete.contact.message': '确定要删除联系人 "${name}" 吗？',
    'error.deleting.contact': '删除联系人失败',
    'warning.no.contacts.selected': '请选择要同步的联系人',
    'warning.no.devices.selected': '请选择要同步的设备',
    'error.syncing.contacts': '同步联系人失败',
    'warning.contact.name.required': '请输入联系人姓名',
    'error.saving.contact': '保存联系人失败',

    'notfound.contacts': '未找到联系人。',

    'permission.plugin_contacts_access': '管理设备联系人',

    'breadcrumb.white.label': '白标定制',
    'heading.white.label': '白标定制 / 品牌重塑',
    ...
    'heading.white.label.builds': '自定义APK构建',
    'heading.white.label.email.templates': '邮件模板',
    'heading.white.label.rebranding': '品牌设置',

    'button.white.label': '白标定制',
    'button.white.label.build': '构建APK',
    'button.white.label.trigger.build': '触发构建',
    'button.white.label.download': '下载APK',
    'button.white.label.new.build': '新建构建',
    'button.white.label.save.template': '保存模板',
    'button.white.label.preview': '预览',

    'table.heading.white.label.build.name': '构建名称',
    'table.heading.white.label.app.name': '应用名称',
    'table.heading.white.label.package': '包名',
    'table.heading.white.label.version': '版本',
    'table.heading.white.label.status': '状态',
    'table.heading.white.label.created': '创建时间',
    'table.heading.white.label.actions': '操作',

    'table.heading.email.template.type': '模板类型',
    'table.heading.email.template.subject': '主题',
    'table.heading.email.template.custom': '自定义',

    'form.white.label.build.name': '构建名称',
    'form.white.label.app.name': '应用名称',
    'form.white.label.package.name': '包名',
    'form.white.label.version.code': '版本代码',
    'form.white.label.version.name': '版本名称',
    'form.white.label.server.url': '服务器地址',
    'form.white.label.icon': '应用图标',
    'form.white.label.splash': '启动画面',
    'form.white.label.custom.colors': '自定义颜色',
    'form.white.label.custom.strings': '自定义字符串',

    'form.rebranding.custom.logo': '自定义Logo',
    'form.rebranding.custom.favicon': '自定义Favicon',
    'form.rebranding.custom.css': '自定义CSS',
    'form.rebranding.primary.color': '主色调',
    'form.rebranding.secondary.color': '次色调',
    'form.rebranding.accent.color': '强调色',
    'form.rebranding.email.header': '邮件头部HTML',
    'form.rebranding.email.footer': '邮件底部HTML',
    'form.rebranding.email.subject.prefix': '邮件主题前缀',
    'form.rebranding.login.page.html': '自定义登录页HTML',
    'form.rebranding.hide.powered.by': '隐藏"Powered by"',
    'form.rebranding.custom.copyright': '自定义版权文字',
    'form.rebranding.custom.domain': '自定义域名',
    'form.rebranding.enable.custom.domain': '启用自定义域名',

    'form.email.template.type': '模板类型',
    'form.email.template.subject': '主题',
    'form.email.template.body.html': 'HTML内容',
    'form.email.template.body.text': '纯文本内容',

    'white.label.status.pending': '等待中',
    'white.label.status.building': '构建中',
    'white.label.status.completed': '完成',
    'white.label.status.failed': '失败',

    'error.white.label.build.not.found': '构建不存在',
    'error.white.label.invalid.package': '无效的包名',
    'error.white.label.build.failed': '构建失败',

    'success.white.label.build.created': '构建配置已创建',
    'success.white.label.build.triggered': '构建已触发',
    'success.white.label.template.saved': '邮件模板已保存',
    'success.rebranding.saved': '品牌设置已保存',

    'notfound.white.label.builds': '未找到构建。',
    'notfound.email.templates': '未找到模板。',
